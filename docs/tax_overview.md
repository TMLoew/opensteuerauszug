# Tax Overview Mode — Kanton St. Gallen Dashboard
...
designed for humans — the Kanton St. Gallen tax clerk, your own review,
and a preparer's self-check.
...
- A Kanton SG-friendly Wertschriftenverzeichnis mapping sheet you can
  copy-paste directly into the canton's form.
...
- **No bilingual rendering.** Labels are German. The standard mode has
  ...
  the primary audience is the Kanton SG tax office.
