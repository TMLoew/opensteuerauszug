...
# openpyxl/Excel custom format strings: apostrophe must be escaped as '\''.
...
def _named(name: str, *, font: Font, fill: PatternFill | None = None,
           number_format: str | None = None, alignment: Alignment = ALIGN_LEFT,
           border: Border | None = BORDER_ROW_BOTTOM) -> NamedStyle:
...
def register_named_styles(workbook) -> None:
    ...
    defs = [
        _named(StyleName.HEADER, font=FONT_HEADER, fill=FILL_HEADER,
               alignment=ALIGN_HEADER, border=None),
        _named(StyleName.BODY_TEXT, font=FONT_BODY, alignment=ALIGN_LEFT),
        _named(StyleName.BODY_CHF, font=FONT_BODY, number_format=NUMBER_FORMAT_CHF,
               alignment=ALIGN_RIGHT),
        _named(StyleName.BODY_NUMBER, font=FONT_BODY, number_format=NUMBER_FORMAT_PLAIN,
               alignment=ALIGN_RIGHT),
        _named(StyleName.BODY_INTEGER, font=FONT_BODY, number_format=NUMBER_FORMAT_INTEGER,
               alignment=ALIGN_RIGHT),
        _named(StyleName.BODY_PERCENT, font=FONT_BODY, number_format=NUMBER_FORMAT_PERCENT,
               alignment=ALIGN_RIGHT),
        _named(StyleName.BODY_DATE, font=FONT_BODY, number_format=NUMBER_FORMAT_DATE,
               alignment=ALIGN_CENTER),
        _named(StyleName.KPI_LABEL, font=FONT_KPI_LABEL, fill=FILL_KPI_TILE,
