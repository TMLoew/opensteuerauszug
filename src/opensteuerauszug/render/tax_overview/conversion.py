...
for audit (the eCH-0196 standard and Kanton SG both expect the conversion
trail to be reproducible).
"""
...
class MoneyCHF:
    ...
    def __add__(self, other: "MoneyCHF") -> "MoneyCHF":
        ...
        return MoneyCHF(
            ...
            source_currency="MIXED" if self.source_currency != other.source_currency
